...
const IndexPage = () => {
  ...
  return (
    <div className="home">
      <SEO
        pageTitle="Home"
        description="Affordable CPA firm serving Cannabis startups in California. We take care of all of your accounting needs: Bookkeeping, SUT & Excise taxes, and of course, 280 mitigation! Call us today!!"
      />
      <Layout>
